package top.ming.feign.plus.register;
...
import top.ming.feign.plus.factory.FeignPlusBeanFactory;
...
//            MergedAnnotation<RequestMapping> requestMapping = ((ScannedGenericBeanDefinition) definition).getMetadata().getAnnotations().get(RequestMapping.class);
            ...
            definition.getPropertyValues().add("url", buildUrl(feignPlus, null));
